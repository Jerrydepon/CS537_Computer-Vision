...
pic_a = imread('./Stereo_images/image11.png');
pic_b = imread('./Stereo_images/image12.png');
% pic_a = imread('./Stereo_images/image21.png');
% pic_b = imread('./Stereo_images/image22.png');
% pic_a = imread('./Stereo_images/image31.png');
% pic_b = imread('./Stereo_images/image32.png');
% pic_a = imread('./Stereo_images/image41.png');
% pic_b = imread('./Stereo_images/image42.png');
% pic_a = imread('./Stereo_images/image51.png');
% pic_b = imread('./Stereo_images/image52.png');

% pic_a = imresize(pic_a, 0.65, 'bilinear');
% pic_b = imresize(pic_b, 0.65, 'bilinear');

%show_correspondence2(pic_a, pic_b,0,0,0,0 );
